...
}`,K=(0,o.keyframes)({"0%":{transform:"scale( 1 )"},"25%":{transform:"scale( 0.97 )"},"50%":{transform:"scale( 0.99 )"},"75%":{transform:"scale( 0.97 )"},"100%":{transform:"scale( 1 )"}}),U=o.css`
	& {
		position: absolute;
		top: 112%;
		right: 0;
...
`,J=e=>{const r=(0,t.useTheme)(),a=(0,o.useCx)();return React.createElement("div",D({tabIndex:"0"},e,{className:a("block-dropdown-renderer-expand-icon",X)}),React.createElement("svg",{stroke:"currentColor",fill:"currentColor",strokeWidth:"0",viewBox:"0 0 20 20",height:"1em",width:"1em",xmlns:"http://www.w3.org/2000/svg",className:a(o.css`
					fill: ${r.answersColor};
				`)},React.createElement("path",{fillRule:"evenodd",d:"M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z",clipRule:"evenodd"})))},Q=e=>{const r=(0,t.useTheme)(),a=(0,o.useCx)();return React.createElement("div",D({},e,{className:a("block-dropdown-renderer-close-icon",X)}),React.createElement("svg",{height:"32",width:"32",viewBox:"0 0 512 512",className:a(o.css`
					fill: ${r.answersColor};
				`)},React.createElement("g",null,React.createElement("g",null,React.createElement("g",null,React.createElement("polygon",{points:"405,136.798 375.202,107 256,226.202 136.798,107 107,136.798 226.202,256 107,375.202 136.798,405 256,285.798 375.202,405 405,375.202 285.798,256 \t\t"},React.createElement("polygon",{points:"405,136.798 375.202,107 256,226.202 136.798,107 107,136.798 226.202,256 107,375.202 136.798,405 256,285.798 375.202,405 405,375.202 285.798,256 \t\t"})))))))};let Z;const ee=({choice:e,blockId:r,choiceIndex:n,val:i,clickHandler:s,showDropdown:l,clicked:u,hovered:d})=>{const[h,f]=(0,a.useState)(!1),g=(0,a.useRef)(),p=(0,o.useCx)();(0,a.useEffect)((()=>{l||f(!1)}),[l]);const b=(0,t.useTheme)(),m=c(b.answersColor),v=i&&i===e.value;return(0,a.useEffect)((()=>(u&&g.current.click(),()=>{u=!1})),[u]),React.createElement("div",{ref:g,id:`block-${r}-option-${n}`,className:p("dropdown__choiceWrapper",{selected:v,isBeingSelected:h},o.css`
					...
					`,G),role:"presentation",onClick:()=>{v&&clearTimeout(Z),v||f(!0),s(),Z=setTimeout((()=>{h&&f(!1)}),400)}},e.label)};let te,re,oe;const ae={display:e=>{var r;const{id:i,attributes:s,setIsValid:l,setIsAnswered:u,setValidationErr:d,val:h,setVal:f,next:g,showErrMsg:p,isActive:b,isTouchScreen:m,setFooterDisplay:v,inputRef:x,isPreview:w,isReviewing:y}=e,{choices:k,required:_}=s,M=(0,o.useCx)(),A=window.self!==window.top,S=(0,t.useBlockTheme)(s.themeId),[C,R]=(0,a.useState)(!1),[E,$]=(0,a.useState)(""),[F,H]=(0,a.useState)(-1),[T,q]=(0,a.useState)(!1),[I,N]=(0,a.useState)(!1),[P,L]=(0,a.useState)(!1),[z,B]=(0,a.useState)(""),[D,j]=(0,a.useState)(!1),[Y,W]=(0,a.useState)(!1),K=(0,a.useRef)(),G=(0,a.useRef)(),X=(0,t.useMessages)(),Z=c(S.answersColor),ae=(0,a.useMemo)((()=>(0,O.cloneDeep)(k).map(((e,t)=>(e.label||(e.label="Choice "+(t+1)),e))).filter((e=>e.label.toLowerCase().includes(h&&m?"":E.toLowerCase())))),[k,E]),ne=e=>{!0!==_||e&&""!==e?(l(!0),d(null)):(l(!1),d(X["label.errorAlert.selectionRequired"]))},ie=e=>{K.current&&!K.current.contains(e.target)&&(R(!1),H(-1))};(0,a.useEffect)((()=>(C?(document.addEventListener("mousedown",ie),document.querySelector(`#block-${i} .renderer-core-field-footer`)&&document.querySelector(`#block-${i} .renderer-core-field-footer`).classList.add("is-hidden")):document.querySelector(`#block-${i} .renderer-core-field-footer`)&&document.querySelector(`#block-${i} .renderer-core-field-footer`).classList.remove("is-hidden"),()=>{document.removeEventListener("mousedown",ie)})),[C]),(0,a.useEffect)((()=>{!w&&y||ne(h)}),[s]),(0,a.useEffect)((()=>(Y?(j(Y),v(!1)):oe=setTimeout((()=>{j(Y)}),500),()=>clearTimeout(oe))),[Y]);const se=e=>{if(L(""!==e.target.value),B(e.target.value),m&&!A||R(!0),h)return f(null),$(""),void ne(void 0);$(e.target.value)};(0,a.useEffect)((()=>{b||re&&clearTimeout(re),N(!1)}),[b]),(0,a.useEffect)((()=>{if(h){const e=ae.find((e=>e.value===h));$(e?e.label:"")}return()=>{re&&clearTimeout(re)}}),[]),(0,a.useEffect)((()=>{I&&g()}),[I]);const le=e=>{if(!m){if(27===e.keyCode)return R(!1),L(""!==z),void H(-1);if(38!==e.keyCode&&40!==e.keyCode){if(13===e.keyCode){if(e.stopPropagation(),-1===F)return R(!1),void H(-1);q(!0)}}else{const t=document.querySelector(`#block-${i}  .qf-block-dropdown-display__choices`);if(!t||F<=0&&38===e.keyCode||F===ae.length-1&&40===e.keyCode)return;R(!0);const r=38===e.keyCode?F-1:F+1;H(r);const o=document.getElementById(`block-${i}-option-${r}`);(function(e,t){const r=e.scrollTop,o=r+e.clientHeight,a=t.offsetTop,n=a+t.clientHeight;return a>=r+10&&n<=o-50})(t,o)||(t.scrollTop=o.offsetTop-30)}}},ce=(e=ae[F])=>{const t=ae.findIndex((t=>t.value===e.value));if(t!==F&&H(t),q(!1),L(!1),p(!1),clearTimeout(te),re&&clearTimeout(re),h&&h===e.value)return f(null),u(!1),$(""),ne(void 0),void N(!1);u(!0),f(e.value),ne(e.value),te=setTimeout((()=>{$(e.label),R(!1),H(-1),m&&!A?(W(!1),v(!0),re=setTimeout((()=>{N(!0)}),750)):N(!0)}),m?500:700)};return React.createElement("div",{ref:K,style:{position:"relative",width:"100%"}},React.createElement("input",{ref:x,className:M(o.css`
						& {
							width: 100%;
							border: none;
							outline: none;
						...
						color: ${S.answersColor};
					`),id:"dropdown-"+i,placeholder:X["block.dropdown.placeholder"],onChange:se,value:h&&m?E:m?"":E,onClick:()=>{m&&!A?(W(!0),x?.current?.blur()):R(!0)},onFocus:()=>{m&&v(!1)},onBlur:()=>{m&&v(!0)},onKeyDown:le,autoComplete:"off"}),h&&h.length>0||P&&(!m||A)?React.createElement(Q,{onClick:()=>{clearTimeout(te),re&&clearTimeout(re),$(""),u(!1),f(void 0),L(!1),m||x.current.focus()}}):React.createElement(J,{style:{transform:C?"rotate(180deg)":"rotate(0deg)"},onClick:()=>{C&&H(-1),m&&!A?W(!Y):(R(!C),x.current.focus())},onKeyDown:e=>{13===e.keyCode&&(e.stopPropagation(),C&&H(-1),m?W(!Y):(R(!C),x.current.focus()))}}),C&&React.createElement("div",{className:M("qf-block-dropdown-display__choices",{visible:C},U,o.css`
							background: ${null!==(r=S.backgroundColor)&&void 0!==r?r:"#fff"};
							padding: 15px;
							border: 1px dashed ${S.answersColor};
						`),ref:G,onWheel:e=>{C&&e.stopPropagation()}},ae?.length>0?ae.map(((e,t)=>React.createElement(ee,{blockId:i,choiceIndex:t,hovered:t===F,clicked:t===F&&T,role:"presentation",key:`block-dropdown-${i}-choice-${e.value}`,clickHandler:()=>ce(e),choice:e,val:h,showDropdown:C}))):React.createElement("div",{className:M(o.css`
								background: ${S.errorsBgColor};
								color: ${S.errorsFontColor};
								display: inline-block;
								padding: 5px 10px;
								border-radius: 5px;
							`)},X["block.dropdown.noSuggestions"])),D&&React.createElement(React.Fragment,null,(0,n.createPortal)(React.createElement("div",{className:M("fixed-dropdown",{show:Y,hide:!Y},V(S)),onWheel:e=>e.stopPropagation()},React.createElement("div",{className:"fixed-dropdown-content",onWheel:e=>{e.stopPropagation()}},React.createElement("div",{className:M(o.css`
											display: flex;
											align-items: center;
