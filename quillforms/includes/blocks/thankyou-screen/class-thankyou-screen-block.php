<?php
/**
 * Block Library: class CustomThankyouScreen_Block_Type
 *
 * @package QuillForms
...
/**
 * Opinion Scale block type
 *
 * @class    Opinion_Scale_Block_Type
 *
 * @since 1.0.0
 */
class Thankyou_Screen_Block_Type extends Block_Type {
	...
	public function get_block_admin_assets() : iterable {
		return array(
			'style'  => '',
			'script' => 'quillforms-blocklib-thankyou-screen-block-admin-script',
		);
	}
	...
	public function get_block_renderer_assets() : iterable {
		return array(
			'style'  => 'quillforms-blocklib-thankyou-screen-block-renderer-style',
			'script' => 'quillforms-blocklib-thankyou-screen-block-renderer-script',
		);
	}
...
Blocks_Manager::instance()->register( new Thankyou_Screen_Block_Type() );
